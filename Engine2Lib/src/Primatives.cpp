...
namespace Engine2
{
	namespace Primatives
	{
		...
		std::vector<PrimativesVertex> Cube::verticies = {
			{ {-0.5f, -0.5f, -0.5f}, {0.0f, 0.0f, -1.0f}, {0.8f, 0.8f, 0.1f, 1.0f} },
			{ {-0.5f, 0.5f, -0.5f},  {0.0f, 0.0f, -1.0f}, {0.8f, 0.8f, 0.1f, 1.0f} },
			{ {0.5f, 0.5f, -0.5f},   {0.0f, 0.0f, -1.0f}, {0.8f, 0.8f, 0.1f, 1.0f} },
			{ {0.5f, -0.5f, -0.5f},  {0.0f, 0.0f, -1.0f}, {0.8f, 0.8f, 0.1f, 1.0f} },
			{ {0.5f, -0.5f, -0.5f},  {1.0f, 0.0f, 0.0f},  {0.8f, 0.1f, 0.1f, 1.0f} },
			{ {0.5f, 0.5f, -0.5f},   {1.0f, 0.0f, 0.0f},  {0.8f, 0.1f, 0.1f, 1.0f} },
			{ {0.5f, 0.5f, 0.5f},    {1.0f, 0.0f, 0.0f},  {0.8f, 0.1f, 0.1f, 1.0f} },
			{ {0.5f, -0.5f, 0.5f},   {1.0f, 0.0f, 0.0f},  {0.8f, 0.1f, 0.1f, 1.0f} },
			...
			{ {-0.5f, 0.5f, 0.5f},   {0.0f, 0.0f, 1.0f},  {0.1f, 0.1f, 0.8f, 1.0f} },
			{ {-0.5f, -0.5f, 0.5f},  {0.0f, 0.0f, 1.0f},  {0.1f, 0.1f, 0.8f, 1.0f} },
			{ {-0.5f, -0.5f, 0.5f},  {-1.0f, 0.0f, 0.0f}, {0.1f, 0.8f, 0.8f, 1.0f} },
			{ {-0.5f, 0.5f, 0.5f},   {-1.0f, 0.0f, 0.0f}, {0.1f, 0.8f, 0.8f, 1.0f} },
			{ {-0.5f, 0.5f, -0.5f},  {-1.0f, 0.0f, 0.0f}, {0.1f, 0.8f, 0.8f, 1.0f} },
			{ {-0.5f, -0.5f, -0.5f}, {-1.0f, 0.0f, 0.0f}, {0.1f, 0.8f, 0.8f, 1.0f} },
			{ {-0.5f, 0.5f, -0.5f},  {0.0f, 1.0f, 0.0f},  {0.1f, 0.8f, 0.1f, 1.0f} },
			{ {-0.5f, 0.5f, 0.5f},   {0.0f, 1.0f, 0.0f},  {0.1f, 0.8f, 0.1f, 1.0f} },
			{ {0.5f, 0.5f, 0.5f},    {0.0f, 1.0f, 0.0f},  {0.1f, 0.8f, 0.1f, 1.0f} },
			{ {0.5f, 0.5f, -0.5f},   {0.0f, 1.0f, 0.0f},  {0.1f, 0.8f, 0.1f, 1.0f} },
			{ {-0.5f, -0.5f, 0.5f},  {0.0f, -1.0f, 0.0f}, {0.8f, 0.1f, 0.8f, 1.0f} },
			{ {-0.5f, -0.5f, -0.5f}, {0.0f, -1.0f, 0.0f}, {0.8f, 0.1f, 0.8f, 1.0f} },
			{ {0.5f, -0.5f, -0.5f},  {0.0f, -1.0f, 0.0f}, {0.8f, 0.1f, 0.8f, 1.0f} },
			{ {0.5f, -0.5f, 0.5f},   {0.0f, -1.0f, 0.0f}, {0.8f, 0.1f, 0.8f, 1.0f} },
		};
